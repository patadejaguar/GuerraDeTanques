    ...
    :ITank(tank_info, nick, rank, color_team)
{
    ...
    _animation_whell = getListOfPixmapFromStripImage(":/xavier_tank_viuda_negra/sprites/whell.png",18);
    _body = QPixmap(":/xavier_tank_viuda_negra/sprites/body.png");
    _turret = QPixmap(":/xavier_tank_viuda_negra/sprites/turret.png");
