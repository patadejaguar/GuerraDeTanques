...
#define gt_plugin "xavier_object_rune_of_armor_v1";
...
class ObjectFactory: public QObject, public IObjectFactory
{
    ...
    public:
        ObjectFactory()
        {
            QPixmap pixmap(":/xavier_object_rune_of_armor/rune_of_armor.png");
        ...
        inline QString          pluginName() const          {return "Runa de armadura";}
        inline QString          nameForDependency() const   {return gt_plugin;}
        inline int              gameVersion() const         {return 1;}

        inline QString          description() const         {return "Aumenta la armadura del tanque por un período de tiempo.";}
