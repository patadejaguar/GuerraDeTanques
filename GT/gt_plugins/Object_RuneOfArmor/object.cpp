...
Object::Object(bool edit_mode):IObject(edit_mode)
{
    ...
    _tileset = getListOfPixmapFromStripImage(":/xavier_object_rune_of_armor/rune_of_armor.png",_width);

    _explode = getListOfPixmapFromStripImage(":/xavier_object_rune_of_armor/explode.png",60);

    _mini_map_view->setPixmap(QPixmap(":/xavier_object_rune_of_armor/mini_map_object.png"));

    _sound = new SoundEngine(QUrl("qrc:/xavier_object_rune_of_armor/rune.mp3"), MECH_MAX_DISTANCE_SOUND, this);

    _effect_animation = getListOfPixmapFromStripImage(":/xavier_object_rune_of_armor/effect_animation.png",85);
}
