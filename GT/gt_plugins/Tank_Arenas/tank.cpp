    ...
    :ITank(tank_info, nick, rank, color_team)
{
    ...
    _animation_whell = getListOfPixmapFromStripImage(":/xavier_tank_arenas/sprites/whell.png",18);
    _body = QPixmap(":/xavier_tank_arenas/sprites/body.png");
    _turret = QPixmap(":/xavier_tank_arenas/sprites/turret.png");
