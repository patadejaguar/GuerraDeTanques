...
#define gt_plugin "xavier_object_rune_of_live_v1";
...
class ObjectFactory: public QObject, public IObjectFactory
{
    ...
    public:
        ObjectFactory()
        {
            QPixmap pixmap(":/xavier_object_rune_of_live/rune_of_live.png");
        ...
        inline QString          pluginName() const          {return "Runa de vida";}
        inline QString          nameForDependency() const   {return gt_plugin;}
        inline int              gameVersion() const         {return 1;}

        inline QString          description() const         {return "Aumenta la vida del tanque por un período de tiempo.";}
