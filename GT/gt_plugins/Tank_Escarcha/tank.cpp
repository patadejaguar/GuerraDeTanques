    ...
    :ITank(tank_info, nick, rank, color_team)
{
    ...
    _animation_whell = getListOfPixmapFromStripImage(":/xavier_tank_escarcha/sprites/whell.png",18);
    _body = QPixmap(":/xavier_tank_escarcha/sprites/body.png");
    _turret = QPixmap(":/xavier_tank_escarcha/sprites/turret.png");
